...
By default import like above  0 (zero), undefined, false, "", and NaN will still show as formdata object. if you don't need to include them just require Truthy  version.
...
es5 : 
    ...
    var obj2fd = require('obj2fd').Truthy;
